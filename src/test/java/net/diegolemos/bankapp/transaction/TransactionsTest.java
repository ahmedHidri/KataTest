...
public class TransactionsTest {
    ...
    @Test public void
    should_compute_withdrawing_transactions_balance() {
        Transactions transactions = new Transactions();
        transactions.add(deposit(30.0));
        transactions.add(Transaction.withdraw(10.0));
        transactions.add(Transaction.withdraw(10.0));

        double balance = transactions.balance();

        assertThat(balance, is(10.0));
    }
    ...
    @Test public void
    balance_should_be_zero_when_WITHDRAWING_AND_BALANCE_IS_NOT_ENOUGH() {
        Transactions transactions = new Transactions();
        transactions.add(Transaction.withdraw(10.0));
        double balance = transactions.balance();
