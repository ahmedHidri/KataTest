...
public class TransactionTest {
    ...
    @Test(expected = IllegalStateException.class) public void
    should_throw_an_exception_when_withdrawing_with_negative_amount() {
    	Transaction.withdraw(-5.0);
    }
    
    @Test public void
    transaction_type_should_be_WITHDRAW_for_every_withdraw_instance() {
        assertThat(Transaction.withdraw(5.0).type(), is(Transaction.Type.WITHDRAW));
    }
}